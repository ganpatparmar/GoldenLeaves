...
import com.skyrider.goldenleaves.activity.LoginActivity
import com.skyrider.goldenleaves.viewmodel.ChannelListViewModel
        ...
        setContent {
            ChatTheme {
                ...
                ChannelsScreen(
                    filters = Filters.`in`(
                        fieldName = "type",
                        values = listOf("Rajkot","jamnagar","Dwarka","Junaghdh","Ahemdabad",
                            "Mehsana","Bhavnagar","Patan","Surendranagr"),
                    ),
                    title = "Channel List",
                    isShowingSearch = true,
                    onItemClick = {
                            channel -> startActivity(MessagesActivity.getIntent(this, channelId = channel.cid))
                    },
